...
fn registry() -> BTreeMap<&'static str, Checker> {
    ...
    payload!("req_entity_get", EntityGetRequest);
    payload!("req_entity_update", EntityUpdateRequest);
    payload!("req_entity_rename", EntityRenameRequest);
    payload!("req_entity_merge", EntityMergeRequest);
    payload!("req_entity_unmerge", EntityUnmergeRequest);
    payload!("req_entity_resolve", EntityResolveRequest);
    payload!("req_entity_list", EntityListRequest);
    payload!("req_entity_tombstone", EntityTombstoneRequest);
    payload!("resp_entity_update", EntityUpdateResponse);
    payload!("resp_entity_rename", EntityRenameResponse);
    payload!("resp_entity_merge", EntityMergeResponse);
    payload!("resp_entity_unmerge", EntityUnmergeResponse);
    payload!("resp_entity_tombstone", EntityTombstoneResponse);
    payload!("resp_entity_get_merged", EntityGetResponse);
    payload!("req_relation_get", RelationGetRequest);
    payload!("req_relation_supersede", RelationSupersedeRequest);
    payload!("req_relation_tombstone", RelationTombstoneRequest);
    payload!("req_relation_list_from", RelationListFromRequest);
    payload!("req_relation_list_to", RelationListToRequest);
    payload!("req_relation_traverse", RelationTraverseRequest);
    payload!("resp_relation_get", RelationGetResponse);
    payload!("resp_relation_supersede", RelationSupersedeResponse);
    payload!("resp_relation_tombstone", RelationTombstoneResponse);
    payload!("resp_relation_list_to", RelationListToResponseFrame);
    payload!("resp_relation_traverse", RelationTraverseResponseFrame);
    payload!("req_statement_get", StatementGetRequest);
    payload!("req_statement_supersede", StatementSupersedeRequest);
    payload!("req_statement_tombstone", StatementTombstoneRequest);
    payload!("req_statement_retract", StatementRetractRequest);
    payload!("req_statement_history", StatementHistoryRequest);
    payload!("req_statement_list", StatementListRequest);
    payload!("resp_statement_supersede", StatementSupersedeResponse);
    payload!("resp_statement_tombstone", StatementTombstoneResponse);
    payload!("resp_statement_retract", StatementRetractResponse);
    payload!("resp_statement_history", StatementHistoryResponseFrame);
    payload!("req_schema_get", SchemaGetRequest);
    ...
    payload!("req_subscribe", SubscribeRequest);
    payload!("req_unsubscribe", UnsubscribeRequest);
    payload!("resp_unsubscribe", UnsubscribeResponse);
    payload!("req_ping", PingRequest);
    payload!("req_client_pong", ClientPongRequest);
    ...
    payload!("resp_encode_vector_direct", EncodeResponse);
    payload!("resp_cancel_stream_ack", CancelStreamAck);
